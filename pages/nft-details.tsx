    ...
    <div className="flexBetweenStart my-5">
      <div className="flex-1 flexStartCenter">
        <div className="relative w-28 h-28">
          <Image alt='' src={nft.image || nftImages[`nft${nft.i}`]} layout="fill" objectFit="cover" />
        </div>
...
const AssetDetails = () => {
  const { nftCurrency, buyNft, currentAccount, isLoadingNFT }: {nftCurrency: any, buyNft: any, currentAccount: any, isLoadingNFT: boolean} = {nftCurrency: true, buyNft: true, currentAccount: true, isLoadingNFT: true}
  const [nft, setNft] = useState({ image: '', itemId: '', name: '', owner: '', price: '', seller: '' , description: '', tokenId: '',
  tokenURI: ''})
  ...
  useEffect(() => {
    ...
    setNft({ image: '', itemId: '', name: '', owner: '', price: '', seller: '', description: '', tokenId: '',
    tokenURI: ''});
    ...
    <div className="relative flex justify-center md:flex-col min-h-screen">
      <div className="relative flex-1 flexCenter sm:px-4 p-12 border-r md:border-r-0 md:border-b dark:border-nft-black-1 border-nft-gray-1">
        <div className="relative w-557 minmd:w-2/3 minmd:h-2/3 sm:w-full sm:h-300 h-557 ">
          <Image  alt="" src={nft.image || nftImages[`nft${nft.itemId}`]} objectFit="cover" className=" rounded-xl shadow-lg" layout="fill" />
        </div>
      </div>
        ...
        <div className="mt-10">
          ...
          <div className="flex flex-row items-center mt-3">
            <div className="relative w-12 h-12 minlg:w-20 minlg:h-20 mr-2">
              <Image alt='' src={images.creator1} objectFit="cover" className="rounded-full" />
            </div>
        ...
        <Modal
          ...
          body={(
            <div className="flexCenter flex-col text-center" onClick={() => setSuccessModal(false)}>
              <div className="relative w-52 h-52">
                <Image alt='' src={nft.image || nftImages[`nft${nft.itemId}`]} objectFit="cover" layout="fill" />
              </div>
