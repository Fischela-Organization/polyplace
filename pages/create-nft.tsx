...
const CreateNFT = () => {
  ...
  const uploadToIPFS = (file: any) => null
  const { isLoadingNFT } = {isLoadingNFT:''}
  const mintNft = async (item1: any, item2: any, item3: any) => {
  ...
  return (
    <div className="flex justify-center sm:px-4 p-12">
      <div className="w-3/5 md:w-full">
        ...
        <div className="mt-16">
          <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-xl">Upload Image</p>
          <div className="mt-4">
        ...
        <div className="mt-16">
          <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-xl">Upload Doc</p>
          <div className="mt-4">
            <div {...getRootProps()} className={fileStyle}>
              <input {...getInputProps()} />
              <div className="flexCenter flex-col text-center">
        ...
        <div className="mt-7 w-full flex justify-end">
          <Button
            ...
            handleClick={() => mintNft(formInput, fileUrl, router)}
          />
        </div>
      </div>
    </div>
