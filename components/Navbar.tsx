...
const MenuItems = ({ isMobile, active, setActive, setIsOpen }: MenuItemsInterface) => {
...
interface ButtonGroupInterface{
  setActive: any, router: any, setIsOpen: any
}

const ButtonGroup = ({ setActive, router, setIsOpen }: ButtonGroupInterface) => {
  const { connectWallet, currentAccount } = {connectWallet: "", currentAccount: ""}
      ...
      <div className="flex flex-1 flex-row justify-start">
        <Link href="/">
          ...
          >
            ...
            <p className="dark:text-white text-nft-black-1 font-bold text-xl ml-1">RealIncom</p>
          </div>
        </Link>
        <Link href="/">
          <div
